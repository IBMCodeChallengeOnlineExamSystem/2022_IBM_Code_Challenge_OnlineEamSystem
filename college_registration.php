...
<script type="text/javascript">
    ...
    function val()
    {
      ...
      else if (document.getElementById("address").value=="" || (!(isNaN(document.getElementById("address").value)))) {
      ...
      else if((document.getElementById("website").value=="")||(!(isNaN(document.getElementById("website").value)))) {
        alert("please enter the website correctly") ;
    ...
    <div id="home" class="hero-area">
      ...
      <div class="home-wrapper">
        <div class="container">
          <div class="row">
            <div class="col-md-8">
             <form name="sentMessage" id="contactForm" onsubmit="return val()"  action="college_registrationAcc.php" method="post">
        <div class="row" align="center">
<table align="center">
  <th><h2 style="color: cornsilk;">College registration</h2></th>
          <tr><td style="color: cornsilk;">Name</td>
            <td><div class="form-group">
              <input type="text" id="name" class="form-control" name = "name"placeholder="name"  style="
    width: auto" required="">
          ...
          <tr><td style="color: cornsilk;">Address</td>
            <td><div class="form-group">
              <input type="text" id="address" class="form-control" name="address" placeholder="address" required style="
    width: auto" required="">
              <p class="help-block text-danger"></p>
            </div></td>
          </tr>
    ...
    width: auto" required="">
           ...
           <tr><td style="color: cornsilk;">Website</td>
            <td><div class="form-group">
              <input type="text" id="website" class="form-control" name="website" placeholder="website" required style="
    width: auto" required="">
              <p class="help-block text-danger"></p>
            </div>
          </td></tr>
           ...
           <tr><td style="color: cornsilk;">Username</td>
            <td><div class="form-group">
              <input type="text" id="username" class="form-control" name="username" placeholder="Username" required style="
    width: auto" required="">
              <p class="help-block text-danger"></p>
            </div>
          </td></tr>
